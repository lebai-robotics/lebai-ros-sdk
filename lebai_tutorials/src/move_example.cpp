...
int main(int argc, char **argv)
{
    ...
    move_joint_srv.request.execute_mode.data = lebai_msgs::ExecuteMode::EXECUTE_MODE_BUFFER;
    ...
    move_line_srv.request.execute_mode.data = lebai_msgs::ExecuteMode::EXECUTE_MODE_BUFFER;
