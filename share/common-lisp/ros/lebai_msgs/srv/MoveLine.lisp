...
(cl:defmethod cl:initialize-instance :after ((m <MoveLine-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveLine-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lebai_msgs-srv:<MoveLine-request> is deprecated: use lebai_msgs-srv:MoveLine-request instead.")))

(cl:ensure-generic-function 'is_joint_pose-val :lambda-list '(m))
(cl:defmethod is_joint_pose-val ((m <MoveLine-request>))
...
(cl:defmethod joint_pose-val ((m <MoveLine-request>))
...
(cl:defmethod cartesian_pose-val ((m <MoveLine-request>))
...
(cl:defmethod common-val ((m <MoveLine-request>))
...
(cl:defmethod execute_mode-val ((m <MoveLine-request>))
...
(cl:defmethod cl:initialize-instance :after ((m <MoveLine-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveLine-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lebai_msgs-srv:<MoveLine-response> is deprecated: use lebai_msgs-srv:MoveLine-response instead.")))

(cl:ensure-generic-function 'ret-val :lambda-list '(m))
(cl:defmethod ret-val ((m <MoveLine-response>))
